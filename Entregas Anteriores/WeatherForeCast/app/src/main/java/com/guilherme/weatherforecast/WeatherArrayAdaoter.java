package com.guilherme.weatherforecast;
...
import com.guilherme.weatherforecast.model.Weather;

import java.util.HashMap;
import java.util.List;
import java.util.Map;

public class WeatherArrayAdaoter extends ArrayAdapter<Weather> {

    private Map<String, Bitmap> bitmaps = new HashMap<>();

    public WeatherArrayAdaoter(@NonNull Context context, List<Weather> forecast) {
